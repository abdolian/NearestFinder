...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className={classnames("container pt-36 px-6 mx-auto flex flex-wrap flex-col items-center", { "animate-slide-up": !!country })}>
        ...
        <div className={classnames("flex flex-col items-center gap-4 w-full lg:flex-row xl:w-8/12", { "animate-fade-in": !!country })} >
